...
import static ladder.domain.ladder.strategy.LadderInitStrategy.Type.*;

public enum LadderInitStrategy implements LadderInitStrategies {
    HARD(
            HARD_TYPE.type,
    ...
    public static final LadderInitStrategy DEFAULT = MEDIUM;
    private static final Map<String, LadderInitStrategy> STRATEGIES =
            Arrays.stream(values())
                    .collect(Collectors.toMap(LadderInitStrategy::getType, Function.identity()));

    LadderInitStrategy(final String type,
    ...
    public static LadderInitStrategy of(final String type) {
